// Salveaza datele din API intr-un array
...
function addtrip() {
    ...
    // Apeleaza functia care face zoom pe oras
    zoomcity();
    ...
    // Functie care parcurge datele provenite de la API si salveaza intr-un array datele
